                        ...
                        <table border="0" class="profile-container">
                            <tr>
                                ...
                                <td style="padding:0px;margin:0px;">
                                    ...
                                    <p class="profile-subtitle">care4u@c4u.com</p>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                ...
                <tr>
                    <td colspan="4">
                        ...
                        <table class="filter-container" style="border: none;" border="0">
                            ...
                            <tr>
                                <td style="width: 25%;">
                                    <div  class="dashboard-items"  style="padding:26px;margin:auto;width:95%;display: flex">
                                        <div>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <p style="padding-bottom:19px;padding-left:50px;font-size:15px;font-weight:500;color:#212529e3;line-height: 20px;">
                                        ...
                                        Refer to appointments section for more details.
                                    </p>
                                ...
                                <td>
                                    ...
                                    <p style="padding-bottom:19px;text-align:right;padding-right:50px;font-size:15px;font-weight:500;color:#212529e3;line-height: 20px;">
                                        ...
                                        Any update features availble in Scedule section.
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td width="50%" style="padding: 0;">
                                    <center>
                                        <div class="abc scroll" style="height: 350px;padding: 0;margin: 0;">
                                        <table width="85%" class="sub-table scrolldown" border="0" >
                                        <thead>
                                        <tr>
                                                <th class="table-headin">
