            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;" >
                        ...
                        <tr >
                            ...
                            <td width="10%">
                                ...
                                <img src="../img/calender.png" width="40%">
                            </td>
                ...
                <tr>
                    ...
                    <tr>
                        <td >
                            ...
                            <i>Welcome to <i><b>We Care</b> dashboard. An overall cure with care</i>. <br> Click on
                                <a href="doctors.php" class="non-style-link"><u>"All Doctors"</u></a> section to find all doctors available <br>and  
                                <a href="schedule.php" class="non-style-link"><u>"Sessions"</u> </a> to
                                track your appointments history.<br><br>
                            </p>
                            
                            <h3>Find the best doctor for you</h3>
                                                ...
                                                <td style="width: 25%;">
                                                    <div  class="dashboard-items"  style="padding:20px;margin:auto;width:95%;display: flex">
                                                        <div>
                                                                ...
                                                                <div class="btn-icon-back dashboard-icons" style="background-image: url('../img/icon/doctor.svg');"></div>
                                                    </div>
                                                </td>
                                                <td style="width: 25%;">
                                                    <div  class="dashboard-items"  style="padding:20px;margin:auto;width:95%;display: flex;">
                                                        <div>
                                                                ...
                                                                <div class="btn-icon-back dashboard-icons" style="background-image: url('../img/icon/patient.svg');"></div>
                                                    </div>
                                                </td>
                                                </tr>
                                                <tr>
                                                <td style="width: 25%;">
                                                    <div  class="dashboard-items"  style="padding:20px;margin:auto;width:95%;display: flex; ">
                                                        <div>
                                                                ...
                                                                <div class="btn-icon-back dashboard-icons" style="margin-left: 0px;background-image: url('../img/icon/appointment.svg');"></div>
                                                    </div>
                                                ...
                                                <td style="width: 25%;">
                                                    <div  class="dashboard-items"  style="padding:20px;margin:auto;width:95%;display: flex;padding-top:21px;padding-bottom:21px;">
                                                        <div>
                                                                ...
                                                                <div class="btn-icon-back dashboard-icons" style="background-image: url('../img/icon/sessions.svg');"></div>
                                                    </div>
                                                </td>
                                        ...
                                        <tbody>
                                            ...
                                            $nextweek=date("Y-m-d",strtotime("+1 week"));
                                                ...
                                                if($result->num_rows==0){
                                                    ...
                                                    <br><br><br><br>
                                                    <center>
                                                    <img src="../img/notfound.webp" width="25%">
